...
import com.imbuka.accounts.dto.ErrorResponseDto;
import com.imbuka.accounts.dto.ResponseDto;
...
@Tag(
        name = "CRUD REST APIs from Accounts in Benki",
        description = "CRUD REST APIs in Benki to CREATE,UPDATE,GET AND DELETE account details"
)
@RestController
...
public class AccountsController {
    ...
    @Operation(
            ...
            description = "REST API to create new Customer & Account inside Benki"
    )
    @ApiResponse(
            responseCode = "201",
